    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-7 col-md-6">
          <div class="img-box">
            <img src="{{ url('website/images/about-img.jpg')}}" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="professional_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="{{ url('website/images/professional-img.png')}}" alt="">
          </div>
        </div>
        <div class="col-md-6 ">
          <div class="detail-box">
        ...
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="{{ url('website/images/client-1.jpg')}}" alt="">
                </div>
          ...
          <div class="item">
            <div class="box">
              <div class="client_id">
                <div class="img-box">
                  <img src="{{ url('website/images/client-2.jpg')}}" alt="">
                </div>
                <div class="client_detail">
                  <div class="client_info">
                    <h6>
